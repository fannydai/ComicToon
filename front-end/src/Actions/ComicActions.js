import { GET_USER_SERIES, GET_SUBSCRIPTIONS, GET_RECENT_CREATIONS, GET_FAVORITES, ADD_PANEL, ADD_UPDATE_PANEL, SAVE_NEW_COMIC_DATA, SAVE_UPDATE_COMIC_DATA, GET_ALL_SERIES, CLEAR_PANELS, DELETE_NEW_COMIC_PANEL, DRAG_NEW_COMIC_PANEL, UPDATE_NEW_COMIC_PANEL, UPDATE_COMIC_PANEL } from './Types';
...
export const updateNewComicPanel = (index, image, json) => (dispatch) => {
    dispatch({
        type: UPDATE_NEW_COMIC_PANEL,
        payload: { index: index, image: image, json: json }
    });
}

export const updateComicPanel = (index, image, json) => (dispatch) => {
    dispatch({
